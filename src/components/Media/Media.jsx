...
class Media extends Component {
  ...
  replaceImageFn = () => {
    ...
    const {
      ...
      replaceImage,
      clearState,
      imageChangeButtonsStatus,
    } = this.props;

    if (replaceImageTarget) {
      const checkExisting = cardList.find(
        (card) => card.char_id === replaceImageTarget.char_id
      );
      if (checkExisting) {
        ...
        {isImageChangeButtons ? (
          <div className="bottom-container">
            <div className="bottom-buttons">
              <button onClick={this.replaceImageFn} className="confirm-button">
                Confirm
              </button>
              <button
        ...
        <div className="media-cards-container">
          {cards?.map((card, key) => (
            <MediaCard
              ...
              replaceImageTarget={replaceImageTarget}
...
const mapDispatchToProps = (dispatch) => ({
  ...
  imageChangeButtonsStatus: (status) =>
    dispatch(imageChangeButtonsStatus(status)),
