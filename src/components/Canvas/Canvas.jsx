...
import { addCard, changePopModelStatus, deleteCard, updateAlert, updateCardList } from '../../redux/canvas/canvas-action';
...
const cardDropTarget = {
    ...
    drop(props, monitor) {
      ...
      const existingChecker = props.cardList?.find(card => card.char_id === item.card.char_id);
...
class Canvas extends React.Component {
    ...
    render() {
        const {  connectDropTarget, cardList, popModelStatus, changePopModelStatus } = this.props;
...
export default connect(mapStateToProps, mapDispatchToProps)(DropTarget(ItemType.MEDIA_CARD, cardDropTarget, collect)(Canvas));
